...
public partial class Testing
{
    ...
    public static async Task<Department> GetDefautITDepartment()
    {
        using var scope = _scopeFactory.CreateScope();

        var appDbContext = scope.ServiceProvider.GetRequiredService<ApplicationDbContext>();

        Department? department = await appDbContext.Departments
                                        .FirstOrDefaultAsync(d => d.Name.Contains("IT"));
    ...
    public static async Task<Department> GetDefautHRDepartment()
    {
        using var scope = _scopeFactory.CreateScope();
        ...
        Department? department = await appDbContext.Departments
                                        .FirstOrDefaultAsync(d => d.Name.Contains("HR"));
